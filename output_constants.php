...
$input['skiarea']['sql'] = '
	SELECT
		...
		e.phone, e.terrain_acres, e.terrain_acres_expert, e.terrain_acres_advanced, e.terrain_acres_intermediate, e.terrain_acres_beginner, e.trails, e.terrain_parks, e.terrain_parks_acres, e.summit, e.base, e.vertical, e.longest_run, e.hours_open, e.hours_close, e.hours_notes, e.lifts_notes, e.tickets_notes, e.location_notes, e.location_link,
